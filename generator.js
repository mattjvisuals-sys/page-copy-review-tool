...
(function(exports) {
  ...
  function getReviewJS() {
    return [
      ...
      '  if(!keys.length){',
      '    document.getElementById("cr-export-text").innerHTML = \'<span class="cr-no-changes">No changes submitted yet.</span>\';',
      '  } else {',
      ...
      'document.addEventListener("keydown",function(e){if(e.key==="Escape"){crCloseModal();document.getElementById("cr-export-modal").classList.remove("cr-open")}});',
      '})();'
    ].join('\n');
  }
